...
import cv2
"from scipy.misc import imresize"  # i'll use cv2.resize function instead, cause it is deprecated
...
IMG_SIZE = 32
BATCH_SIZE = 16
DATASET_DIR = r'C:\Users\Cesc47\PycharmProjects\MCV\M4\MIT_split'
MODEL_FNAME = r'C:\Users\Cesc47\PycharmProjects\MCV\M4\models'
...
x = np.expand_dims(cv2.resize(x, (IMG_SIZE, IMG_SIZE, 3)), axis=0)
